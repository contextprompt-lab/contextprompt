...
## Kill on sight
- Any sentence that sounds like ChatGPT wrote it — "In today's fast-paced world", "It's worth noting", "Let's dive in", "In conclusion", "leverage", "streamline", "game-changer"
...
- If any section feels thin, add a real example or cut the section shorter
